...
<body>
    ...
    <?php 
        ...
        orgEmail,orgTinNumber FROM orgDetails");
    ?>
    <!-- //VIew -->
    <?php 
        ...
        <div class="table-responsive"> <!--table Responsive make the table have scroll on bottom -->
            <table id="dataTable" class="table table-striped table-bordered " style="width:100%">
                ...
                <?php 
                    ...
                    echo ("</td><td>");
                    echo ('<a class="btn" href="edit.php?orgID=' .$row['orgID'] . '">EDIT</a>');
                    echo ('<a class="btn btn-danger" href="edit.php?orgID='  .$row['orgID'] . '">DELETE</a> ');
                    echo ('</td></tr>');
                }
                ?>
